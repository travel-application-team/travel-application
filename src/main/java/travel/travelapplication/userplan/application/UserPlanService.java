...
public class UserPlanService {
  ...
  public void updateUserPlanInfo(User user, UserPlan userPlan,
      UpdateUserPlanInfoRequest userPlanInfoDto) {
    ...
    if (isPublic(userPlan.getStatus())) {
      shareUserPlan(updatedUserPlan,
          user); // 만약 공개로 그대로 두고, 이름을 게속 바꾸면 이름만 다른 동일한 일정이 계속 저장되는 문제 발생
    } else {
